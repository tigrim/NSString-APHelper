...
+ (NSString *)sha1HashFromData:(NSData *)data {
    return [self shaHashFromData:data length:CC_SHA1_DIGEST_LENGTH];
}

+ (NSString *)sha224HashFromData:(NSData *)data {
    return [self shaHashFromData:data length:CC_SHA224_DIGEST_LENGTH];
}

+ (NSString *)sha256HashFromData:(NSData *)data {
    return [self shaHashFromData:data length:CC_SHA256_DIGEST_LENGTH];
}

+ (NSString *)sha384HashFromData:(NSData *)data {
    return [self shaHashFromData:data length:CC_SHA384_DIGEST_LENGTH];
}

+ (NSString *)sha512HashFromData:(NSData *)data {
    return [self shaHashFromData:data length:CC_SHA512_DIGEST_LENGTH];
}
...
+ (NSString *)sha1HashFromString:(NSString *)string {
    return [self shaHashFromString:string length:CC_SHA1_DIGEST_LENGTH];
}

+ (NSString *)sha224HashFromString:(NSString *)string {
    return [self shaHashFromString:string length:CC_SHA224_DIGEST_LENGTH];
}

+ (NSString *)sha256HashFromString:(NSString *)string {
    return [self shaHashFromString:string length:CC_SHA256_DIGEST_LENGTH];
}

+ (NSString *)sha384HashFromString:(NSString *)string {
    return [self shaHashFromString:string length:CC_SHA384_DIGEST_LENGTH];
}

+ (NSString *)sha512HashFromString:(NSString *)string {
    return [self shaHashFromString:string length:CC_SHA512_DIGEST_LENGTH];
}
